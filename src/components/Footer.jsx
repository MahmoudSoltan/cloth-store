    ...
    <footer className='bg-gray-900 text-gray-200 py-10'>
      <div className='max-w-7xl mx-auto px-4 md:flex md:justify-between'>
        ...
        <div className='mb-6 md:mb-0'>
            ...
            <p className='text-sm'>Email: support@clothstore.com</p>
            <p className='text-sm'>Phone: +(86) 186-0044-3926</p>
        </div>
      ...
      <div className='mt-8 border-t border-gray-700 pt-6 text-center text-sm'>
        <p>&copy; {new Date().getFullYear()}<span className='text-red-500'> Cloth Store</span> , All rights reserved & Developed By Mahmoud Soltan</p>
      </div>
    </footer>
  )
}
